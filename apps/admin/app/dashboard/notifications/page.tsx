          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Select value={filterType} onValueChange={setFilterType}>
              ...
              <SelectContent className="bg-muted border-border">
                ...
                <SelectItem value="stock_critical">Stock Crítico</SelectItem>
                <SelectItem value="stock_out">Stock Agotado</SelectItem>
                <SelectItem value="stock_adjusted">Inventario Ajustado</SelectItem>
                <SelectItem value="order_new">Nuevo Pedido</SelectItem>
                <SelectItem value="order_status">Estado de Pedido</SelectItem>
              </SelectContent>
            </Select>
