      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Administra todos los usuarios de tu plataforma</p>
          </div>
        </div>
            ...
            <TableBody>
              {paginatedUsers.map((user) => (
                <TableRow key={user.id} className="border-border hover:bg-muted/50">
                  ...
                  <TableCell className="text-muted-foreground">{formatDate(user.registrationDate)}</TableCell>
                  <TableCell>
                    <Badge
                      className={
                        user.status === "active"
