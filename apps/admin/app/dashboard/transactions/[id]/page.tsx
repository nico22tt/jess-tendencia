...
export default function TransactionDetailPage() {
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto p-6">
            <div className="max-w-5xl mx-auto">
              <p className="text-zinc-400 text-center">Cargando orden...</p>
            </div>
          </main>
        </div>
      </div>
  ...
  const firstImage = order.order_items[0]?.products?.images?.[0] || null
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 mt-1">Creado el {formatDate(order.created_at)}</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                      ...
                      return (
                        <div key={item.id} className="flex gap-4 p-4 bg-zinc-800/50 rounded-lg">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-400">SKU: {item.products.sku}</p>
                            <div className="flex items-center gap-4 mt-2">
                              <span className="text-zinc-400">Cantidad: {item.quantity}</span>
                              <span className="text-zinc-400">Precio: {formatCurrency(item.unit_price)}</span>
                            </div>
                          </div>
                ...
                {/* Totales */}
                <Card className="bg-zinc-900 border-zinc-800 p-6">
                  <h2 className="text-xl font-semibold text-white mb-4">Resumen de Pago</h2>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-zinc-900 border-zinc-800 p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-zinc-400">{order.users.email}</p>
                  </div>
                </Card>
                ...
                <Card className="bg-zinc-900 border-zinc-800 p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p className="text-zinc-400">{order.shipping_phone}</p>
                    <p className="text-zinc-400">{order.shipping_address}</p>
                    <p className="text-zinc-400">{order.shipping_city}, {order.shipping_region}</p>
                    <p className="text-zinc-400">CP: {order.shipping_zip}</p>
                  </div>
                </Card>
                ...
                {order.payment_method && (
                  <Card className="bg-zinc-900 border-zinc-800 p-6">
                    ...
                    <p className="text-zinc-400 capitalize">{order.payment_method}</p>
                  </Card>
                )}

                {/* Cambiar estado */}
                <Card className="bg-zinc-900 border-zinc-800 p-6">
                  <h2 className="text-lg font-semibold text-white mb-4">Actualizar Estado</h2>
                  <div className="space-y-4">
                    <Select value={newStatus} onValueChange={setNewStatus}>
                      ...
                      <SelectContent className="bg-zinc-800 border-zinc-700">
                        ...
                        <SelectItem value="REFUNDED" className="text-white">Reembolsado</SelectItem>
                      </SelectContent>
                    </Select>
                    <Button 
