...
// Simula la DB con estado temporal
const initialImages = [
...
export default function AddProductPage() {
  ...
  const handleSaveProduct = () => {
    ...
    // Simulación: Guarda en memoria y muestra feedback
    console.log("[v0] Nuevo producto simulado:", newProduct)
    setSaved(true)
    setTimeout(() => setSaved(false), 3000)
    // Aquí puedes redirigir, limpiar o navegar a la edición si lo deseas
  }
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            {saved && (
              <div className="bg-green-900 border border-green-700 rounded-lg p-4 text-green-300 text-center font-semibold">
                Producto agregado exitosamente (simulación)
              </div>
            )}
