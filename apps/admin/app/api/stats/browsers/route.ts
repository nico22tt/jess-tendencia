...
// (resuelve a ../../packages/shared/lib/prisma.ts)
...
export async function GET() {
  try {
    ...
    // Prepara el array para el frontend, ordenados mayor a menor
    ...
    return NextResponse.json({ error: "No se pudieron consultar los navegadores" }, { status: 500 });
  }
}
