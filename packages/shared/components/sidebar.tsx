...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 h-full w-72 bg-white/95 backdrop-blur-md border-r border-pink-100 pt-20 transition-all duration-300 ease-out shadow-2xl",
          // Z-index y posicionamiento
          "z-[50] lg:z-auto",
          // Posicionamiento desktop: relative para flujo normal
